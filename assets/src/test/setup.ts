...
vi.mock('../utils/icons', async () => {
  ...
  return {
    ...
    TimerIconComponent: MockIcon,
    GlobeIcon: MockIcon,
    StarIconComponent: MockIcon,
    TrashIconComponent: MockIcon,
    PlusIconComponent: MockIcon,
    CheckIconComponent: MockIcon,
    CloseIcon: MockIcon,
