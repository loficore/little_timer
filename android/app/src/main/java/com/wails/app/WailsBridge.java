...
// JNI-binding layer: must live at com.wails.app to match libwails.so's
// hardcoded symbol names. Application-namespace collaborators live in
// com.littletimer and are imported explicitly here.
import com.littletimer.BuildConfig;
import com.littletimer.MainActivity;
import com.littletimer.WailsForegroundService;
...
public class WailsBridge {
    ...
    /** Forward a picked file path to Go. */
    public void filePickerResult(int callbackID, String path) {
    ...
    /** Signal the end of a file picking session. */
    public void filePickerDone(int callbackID) {
